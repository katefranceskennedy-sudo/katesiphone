...
export default function ProjectsTitle() {
  ...
  useEffect(() => {
    ...
    function update() {
      ...
      console.debug("ProjectsTitle: headerBottom", headerBottom, "mainTop", mainTop, "finalMargin", marginTop);
      ...
      setTimeout(() => {
        ...
        // eslint-disable-next-line no-console
        console.debug("ProjectsTitle (delayed): headerBottom", hb, "mainTop", mt, "finalMargin", m2);
