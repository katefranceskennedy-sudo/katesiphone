// GIF removed from page; no external links used here
...
export default function FannysPage(){
  ...
  <div style={{ maxWidth: 1100, width: '100%', margin: '0 auto', background: 'transparent', boxShadow: 'none', borderRadius: 0, overflow: 'hidden', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div style={{ padding: 0, transform: 'translateY(-100px)' }}>
          ...
          >
            <span className="reticence-title">The Reticence</span>
            <style>{`
              .reticence-title {
                font-family: Inter, system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;
                font-weight: 300;
                font-size: 0.95rem;
                color: #3b2f2f; /* deep brown text tone */
                text-decoration: none;
                display: inline-block;
                padding: 4px 8px 6px 8px;
                border-radius: 4px;
                transition: background-color 120ms ease;
                background-color: #f5f3ff; /* light purple highlight */
              ...
              .reticence-title:hover {
                /* switch to solid underline on hover */
                background-image: linear-gradient(#8b5e3c, #8b5e3c);
                background-size: 100% 3px;
                background-position: 0 calc(100% - 3px);
                background-repeat: no-repeat;
                background-color: #e9d5ff; /* slightly stronger purple on hover */
              }

              .reticence-title:focus-visible {
                outline: 2px solid #ede9fe;
                outline-offset: 2px;
              }
            `}</style>
          </h1>
          {/* layout: centered article content */}
          <div className="newman-layout" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '40px', flexWrap: 'wrap' }}>
            <div className="newman-text" style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'left' }}>
          ...
          <div className="newman-fulltext" style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'left' }}>
...
Julie Birchil”</p>
          ...
          <style>{`
            /* Solid red underline across all body text in Fannys */
            .newman-text p,
            .newman-fulltext p,
            .newman-fulltext blockquote p,
            .newman-text blockquote p {
              text-decoration-line: underline;
              text-decoration-color: #c40000; /* deep red */
              text-decoration-thickness: 2px;
              text-underline-offset: 3px;
              text-decoration-style: solid;
            }

            /* Ensure inline emphasis inherits underline */
            .newman-text p strong,
            .newman-fulltext p strong,
            .newman-fulltext blockquote p strong,
            .newman-text p em,
            .newman-fulltext p em {
